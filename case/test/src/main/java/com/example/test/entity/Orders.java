...
public class Orders {
    ...
    public Orders() {}
    public Orders(int order_ID, Date order_Date, int order_TotalAmount, String order_Status) {
    ...
    public int getOrder_TotalAmount() {return order_TotalAmount;}
    public void setOrder_TotalAmount(int order_TotalAmount) {this.order_TotalAmount = order_TotalAmount;}
